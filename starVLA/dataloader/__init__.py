...
def build_dataloader(cfg, dataset_py="lerobot_datasets_oxe"): # TODO now here only is get dataset, we need mv dataloader to here
    ...
    elif dataset_py == "cogact_datasets":
        from starVLA.dataloader.cogact_datasets import collate_fn, get_cogact_dataset

        vla_dataset_cfg = cfg.datasets.vla_data
        vla_dataset = get_cogact_dataset(vla_dataset_cfg)
        num_workers = int(vla_dataset_cfg.get("num_workers", 4))
        dataloader_kwargs = {
